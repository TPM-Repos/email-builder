...
const EMAIL_VERIFICATION: TEditorConfiguration = {
  root: {
    type: 'EmailLayout',
    data: {
  ...
  'block-1743003242864': {
    ...
    data: {
      ...
      props: {
        text: 'Account Request Created, Please use the link below to verify your Email address.'
      }
    }
  },
  'block-1743003315381': {
    ...
    data: {
      ...
      props: {
        ...
        size: 'large',
        text: 'Verify Email',
        url: '{DRIVEWORKS_VARIABLE_VERIFY_EMAIL_URL}'
      }
    }
  },
  'block-1743003368624': {
